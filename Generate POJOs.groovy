...
def generate(out, className, fields, table) {
    ...
    out.println ""
    out.println "import com.df.jpa.dbbase.model.BaseJpaModel;"
    ...
    out.println "/**\n" +
            ...
            " * \n" +
            " * @author Child\n" + // 1. 修改idea为自己名字
            " * @since " + LocalDate.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd")) + " \n" +
            " */"
//    out.println ""
    out.println "@Data"
    ...
    out.println "public class $className extends BaseJpaModel implements Serializable {"
    out.println ""
    ...
    // 实现: org.springframework.data.domain.Persistable.getId
    out.println ""
...
def calcFields(table) {
    DasUtil.getColumns(table).reduce([]) { fields, col ->
        ...
        // 主键
        if ("CHANGYONGYUID".equalsIgnoreCase(Case.LOWER.apply(col.getName())))
            comm.annos += ["@Id"]
        fields += [comm]
    }
}
